...
// jest.mock("../Api/api", () => ({
//   __esModule: true,
//   default: { getAllCals: "test" },
// }));

jest.mock("../Api/api", () => ({
  getAllCals: jest.fn().mockResolvedValue([
  ...
  ComeAwayApi: {
    ...
    getBeginHours: jest.fn().mockResolvedValue([
    ...
    getEndHours: jest.fn().mockResolvedValue([
    ...
    getMonths: jest.fn().mockResolvedValue([
      { id: 1, month: "January" },
      { id: 2, month: "February" },
    ]),
    getDays: jest.fn().mockResolvedValue([
      { id: 1, day: "1" },
      { id: 2, day: "2" },
    ]),
    getAllDueDates: jest.fn().mockResolvedValue([
      {
        id: 1,
        babyName: "testbaby",
        yearId: 1,
    ...
    createVisit: jest.fn().mockResolvedValue([
      {
